...
#feature_data_all = pd.read_csv('C:/Users/Administrator/Desktop/zl/tianchi/fusai_data/feature_data_2017_456_7.csv',dtype={'link_ID':str})
#
...
for label_lengh in range(2,0,-1):
    #label_lengh=1
    #test_pred5 = pd.read_csv('C:/Users/Administrator/Desktop/zl/tianchi/fusai/9_13/jiaocha'+'/LSTM_pred_m6_'+str(label_lengh)+'.csv',dtype={'link_ID':str})
